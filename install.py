...
if os.path.exists(dot_vimrc_location) and not os.path.exists(os.readlink(dot_vimrc_location)):
    os.unlink(dot_vimrc_location) 
os.symlink(vimrc_location, dot_vimrc_location)

if os.path.exists(dot_screenrc_location):
    os.unlink(dot_screenrc_location)
if os.path.exists(dot_screenrc_location) and not os.path.exists(os.readlink(dot_screenrc_location)):
    os.unlink(dot_screenrc_location) 
